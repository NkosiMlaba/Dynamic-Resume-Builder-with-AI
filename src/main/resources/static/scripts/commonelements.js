...
<div class="contact-info-upper-container">
    <div class="contact-info-container">
        <img src="../static/assets/email_image.png" alt="Email icon" class="icon contact-icon email-icon" />
        <p><a href="mailto:nkosimlaba397@gmail.com">nkosimlaba397@gmail.com</a></p>
    </div>
    <div class="contact-info-container">
        <img src="../static/assets/linkedin_image.png" alt="LinkedIn icon" id="linkedin-icon-contact"
